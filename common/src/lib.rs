...
///Type definition representing financial basis point (1 bp is 0.01%)
pub type BasisPoint = u16;
...
///Sorting of keys and values by key with hash_key, useful for crypto sorting with commutative merkle operation
